...
def create_revenue_report():
    ...
    details_data = [
        ...
        [
            ...
            "Sarah Chen",
            "Infrastructure lift-and-shift to AWS",
            "2024-10-01",
            "2024-12-31",
            85000.00,
            60000.00,
        ...
        [
            ...
            "Northgate Industries",
            "Daniel Park",
            "SAP integration with legacy billing system",
            "2024-11-01",
            "2024-12-31",
            57500.00,
            38750.00,
        ...
        [
            ...
            "Apex Solutions LLC",
            "Marcus Webb",
            "Power BI dashboard for pipeline visibility",
            "2024-09-15",
            "2024-12-31",
            87300.00,
            61200.00,
        ...
        [
            ...
            "Riverfront Corp",
            "Sarah Chen",
            "Full-stack modernization of customer portal",
            "2024-07-01",
            "2024-12-31",
            130000.00,
            91000.00,
        ...
        [
            ...
            "Coastal Dynamics",
            "Marcus Webb",
            "HubSpot implementation and CRM migration",
            "2024-08-01",
            "2024-12-31",
            98400.00,
            68100.00,
        ...
        [
            ...
            "Coastal Dynamics",
            "Priya Nair",
            "Snowflake DW with dbt transformation layer",
            "2024-10-01",
            "2024-12-31",
            80000.00,
            56000.00,
        ...
        [
            ...
            "Meridian Tech",
            "Sarah Chen",
            "Kubernetes cluster build-out and CI/CD pipeline",
            "2024-06-01",
            "2024-12-31",
            195000.00,
            136500.00,
        ...
        [
            ...
            "Meridian Tech",
            "Daniel Park",
            "LLM-powered document processing proof of concept",
            "2024-10-01",
            "2024-12-31",
            120000.00,
            84000.00,
        ...
        [
            ...
            "Irongate Ventures",
            "Jordan Hayes",
            "Go-to-market strategy for Series B expansion",
            "2024-09-01",
            "2024-12-31",
            127600.00,
            89320.00,
        ...
        [
            ...
            "Clearwater Group",
            "Sarah Chen",
            "Salesforce implementation with custom CPQ",
            "2024-10-15",
            "2024-12-31",
            68900.00,
            49400.00,
    ...
    team_data = [
        ...
        [
            "Jordan Hayes",
            "Consultant",
            "j.hayes@example-consulting.com",
            "555-0231",
            "San Francisco, CA",
        ],
        [
...
def create_team_roster():
    ...
    data = {
        ...
        "Email": [
            "j.morrison@example.com",
            "l.fitzgerald@example.com",
            "r.okafor@example.com",
            "p.sullivan@example.com",
            "m.hernandez@example.com",
            "b.whitfield@example.com",
            "w.nakamura@example.com",
            "s.delgado@example.com",
            "d.patel@example.com",
            "j.thornton@example.com",
            "r.beaumont@example.com",
            "k.ashworth@example.com",
            "j.reyes@example.com",
            "n.yamamoto@example.com",
        ...
        "Bonus %": [15, 12, 15, 10, 20, 18, 12, 8, 15, 20, 20, 10, 20, 12, 10],
        "Annual Bonus": [
            21750,
            15360,
            20700,
